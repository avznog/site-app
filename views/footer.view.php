...
<head>
    <title>Footer</title>
    <link rel="stylesheet" href="style/footer.css" type="test/css" />
...
<body>
    <footer class="footer">
        <div class="l1">
            <div class="c1">
                <p><a class="jiacu" href="">Entreprise</a></p>
        ...
        <div class="l3">
            <div class="left">
                <p>&copy; 2022 Gaïa Protect incorporation et de ses filiales. Tous droits réservés. Take’R</p>
            </div>
